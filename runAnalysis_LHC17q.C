...
*************************/
    ...
    if(local) {
        ...
        alienHandler->SetGridWorkingDir("myWorkingDir_LHC17q_CENT_woSDD/"); // ### !!!
        ...
        if(isMC){
            ...
            // path = /alice/data/2017/LHC17q/000282367/pass1_CENT_wSDD/AOD208/0001/AliAOD.root
            alienHandler->SetGridDataDir("/alice/data/2017/LHC17q/");
